...
const Post=(()=>{    
    ...
    useEffect(()=>{ 
        ...
        const fetchData =async ()=>{
                try{
                    ...
                    const userDetailsPromisis=uniqueUserIds.map(userId =>
                        axios.get(`https://farmers-social-media-backend.onrender.com/api/getuserdetails/${userId}`)
                    )
        ...
        const handleComment = async (postId) => {
            ...
            try {
                const response = await axios.post(
                    `https://farmers-social-media-backend.onrender.com/api/comment/${postId}`,
        ...
        const handleToggleComments = async(postId) => {
            ...
            try {
                const response = await axios.get(
                    `https://farmers-social-media-backend.onrender.com/api/getcomment/${postId}`,
                );
        ...
        const handleLike = async (postId, index) => {
            ...
            try {
                await axios.put(`https://farmers-social-media-backend.onrender.com/api/addlike/${postId}`, {
                    likeUserId: userId
                });
                setPosts((prevPosts) => {
